...
The essay advances a moderate claim: when traditions develop reflective philosophical cores under pressure for coherence, those cores tend to satisfy certain structural constraints. This convergence is more likely to reflect features of reality than cultural accident, but the inference is defeasible.
...
## II. The Primary Constraint: Non-Arbitrary Structure
...
**Deterministic alignment** (one traditional answer): Freedom as recognition of necessity—accepting what must be and adjusting one's attitudes accordingly. This is the Stoic emphasis on what is "up to us" (our judgments) versus what is not (external events). There is wisdom here: struggling against the nature of things is exhausting and futile. But if reality is not fully deterministic—if structure constrains without uniquely specifying—then freedom involves more than acceptance.

**Creative participation** (the fuller picture): Freedom as the actualization of possibilities within structured possibility space. Structure determines the range of what *can* occur and the probabilities of various outcomes, but does not uniquely determine which possibility becomes actual. The agent participates in this actualization—not as arbitrary will imposing itself on passive matter, but as interiority contributing to the determination of what, among structured possibilities, becomes real.

This third conception preserves what is right in the first two while avoiding their excesses. Against voluntarism: freedom operates within constraint, not against it; the structure is discovered, not created. Against pure determinism: the agent genuinely contributes to outcomes, not merely to attitudes about outcomes; there is something "up to us" beyond our judgments.
...
### Non-Arbitrariness Without Determinism

A clarification is necessary here, because non-arbitrary structure is easily confused with determinism. The constraint does not require that reality is deterministic—that prior states uniquely specify all subsequent states. It requires only that reality exhibits discoverable structure, not that this structure eliminates all degrees of freedom.

The distinction matters. Consider quantum mechanics. The Born rule specifies exactly what the probability distribution is for measurement outcomes. This distribution is not chosen by anyone; it follows from the wave function with mathematical necessity. What remains indeterminate is which outcome within that distribution actualizes—but the *space of possible outcomes* and their relative likelihoods are fully constrained. This is structure. It is discoverable. It is not willed or arbitrary. It simply does not uniquely determine a single outcome.
...
This matters for consciousness-first metaphysics. On idealist interpretations, the wave function describes the structure of possibilities within mind-at-large; measurement is the actualization of one possibility into definite experience. The degrees of freedom here are constrained by structure (the wave function, Hilbert space, unitary evolution) but not fully determined. What is "free" is not the structure but which structured possibility becomes actual. This is compatible with non-arbitrariness because the range of possibilities and their probabilities are not products of will—they are discoverable features of how reality is configured.

Process philosophy makes this explicit. Whitehead holds that each occasion of experience involves both causal inheritance (structured, given) and creative advance (novel, not fully determined). Creativity operates *within* the constraints of eternal objects and causal history. This is non-deterministic but not arbitrary: novelty emerges within structure, not against it or independent of it.

What the constraint excludes is unconstrained voluntarism—the idea that outcomes could be anything at all depending on arbitrary will. Quantum indeterminacy is not this: possibilities are tightly constrained; what is open is which possibility actualizes. Structure can constrain without eliminating all degrees of freedom. Non-arbitrariness is compatible with genuine openness, creativity, and the irreducible role of interiority in actualizing possibilities.

### Convergence Across Traditions

The traditions converge on non-arbitrary structure while diverging on whether that structure is deterministic. Some affirm strict necessity; others allow for creative participation within constraint. Both reject voluntarism; they differ on whether structure fully specifies outcomes. This divergence is compatible with the primary constraint: what matters is that structure is discovered, not willed—not whether that structure leaves room for indeterminacy.
...
**Stoicism** represents the deterministic pole of this convergence. *Logos*—rational principle—pervades and governs the cosmos. The sage aligns with logos; fighting it is not merely wrong but futile. "Living according to nature" (*secundum naturam vivere*) means recognizing and accepting reality's structure. The Stoic cosmos is deterministic: everything that happens follows necessarily from prior causes according to logos. This is not fatalism but recognition that the structure of events is not up to us. What is up to us (*eph' hēmin*) is our response—our judgments, assent, character. Marcus Aurelius: "Accept the things to which fate binds you, and love the people with whom fate brings you together." For the Stoics, the structure is fully given; alignment is the only freedom.

**Spinoza** develops determinism with geometric rigor. Everything follows from the nature of God/Nature (*Deus sive Natura*) with logical necessity. There is no divine will choosing among possibilities; only the unfolding of what must be given the nature of substance. God does not deliberate, prefer, or choose. The structure of reality is necessary, not contingent on any decision. Human freedom is not the power to violate necessity but to act from one's own nature rather than external causes—to be *causa sui* to the extent possible for a finite mode. Spinoza explicitly rejects the voluntarist God who acts for purposes; such a God would be subject to the purposes, making the purposes rather than God the ultimate ground.
...
**Mystical Christianity** in its most refined forms subordinates divine will to divine nature. Meister Eckhart: "God cannot not give birth to the Son"—the procession of the Trinity is not a divine choice but follows from the divine nature necessarily. The Godhead (*Gottheit*) is beyond the personal God who wills and acts; it is the ground from which the Trinity emerges by inner necessity. Pseudo-Dionysius describes God as "beyond being"—but this means beyond the category of beings who might choose to be this way or that. The divine names (Goodness, Being, Life, Wisdom) are not arbitrary labels God chose but necessary expressions of the divine nature, discoverable through contemplation. Aquinas, while affirming divine will, insists that God's will and intellect are identical with God's essence—God wills what God is, not arbitrarily but necessarily. The voluntarist surface of command theology yields, under sustained inquiry, to the recognition that divine goodness has structure independent of fiat.

**Sufism** recovers constraint through the doctrine of the *a'yan al-thabita* (fixed archetypes). Ibn Arabi holds that these archetypes in divine knowledge are the eternal patterns according to which manifestation unfolds. God does not choose these patterns by will; they are the necessary consequences of divine nature knowing itself. The structure of the *tajalliyat* (divine self-disclosures) follows from the nature of the divine names, not from arbitrary decree. Al-Ghazali's famous critique of causation in *Tahafut al-Falasifa* represents the occasionalist position—but even al-Ghazali, in *Mishkat al-Anwar*, describes a hierarchy of veils between the seeker and the Light of Lights, a structure to be discovered rather than a decree to be obeyed. The Sufi *tariqa* (path) is a method for uncovering what is already the case, not for petitioning arbitrary will. The mystic discovers the structure of reality; the structure is not made to order.

**Kabbalah** expresses constraint through the nature of emanation. The ten *sefirot* and their complex interrelationships are not chosen by divine will but follow from the nature of *Ein Sof* expressing itself. The *sefirot* (*Keter*, *Chokhmah*, *Binah*, through to *Malkhut*) are not arbitrary creations but necessary articulations of infinite light into knowable attributes. The Kabbalist discovers this structure through contemplation, textual interpretation, and revelatory tradition; the structure precedes and constrains inquiry. Even the *shevirat ha-kelim* (breaking of the vessels)—the primordial catastrophe in Lurianic Kabbalah—is not an accident of will but a structural necessity in the transition from infinite to finite. The "fall" is built into the architecture of manifestation; it is not a contingent choice. The commandments (*mitzvot*) are reframed as structural alignments—practices that repair the *sefirot* and restore the flow of divine light, not arbitrary divine preferences.

**Process philosophy** (Whitehead) holds that even God is not the source of structure but a feature within it. God's "primordial nature" provides initial aims to each occasion of experience, but these aims derive from the eternal objects (pure potentials) that God does not create. The structure of possibility itself is not willed by any agent; God and the world are both within a wider structure of creativity. Whitehead explicitly rejects the "imperial" God who creates by decree; the process God is "the great companion—the fellow-sufferer who understands," not the cosmic legislator.

**Analytic idealism** (Kastrup) articulates non-arbitrary structure within a consciousness-first framework. Mind-at-large—the universal field of experience—is a structured field whose regularities we call physical laws. These regularities are not arbitrary preferences but stable patterns discoverable through inquiry. The dissociation that produces individual minds follows structural dynamics analogous to dissociative identity disorder. Crucially, analytic idealism interprets quantum field theory as revealing this structure. The Born rule specifies the probability distribution over outcomes with mathematical necessity; what remains open is which possibility actualizes in experience. This is non-arbitrary structure that permits creative participation—the structure constrains without fully determining, and minds participate in actualization without authoring the constraints.

**Confucianism** expresses constraint through *li* (principle, pattern) and *tian* (heaven, the natural order). The Confucian sage does not invent moral order but discerns it. *Ren* (humaneness), *yi* (righteousness), and *li* (ritual propriety) are not conventions but expressions of the structure of proper human relationship. Later Neo-Confucians (Zhu Xi) make this explicit: *li* is the principle inherent in all things, preceding and constraining the *qi* (material force) through which things manifest. The sage investigates things to understand *li*; the structure is discovered, not legislated.

The pattern is consistent: where traditions are pushed to their limits, divine or cosmic will becomes subordinate to nature or structure, and that nature turns out to be discoverable rather than arbitrary. The voluntarist God who creates by fiat recedes; the ground of intelligibility emerges.
...
**Stoicism** holds that the cosmos is eternal and rational, pervaded by *logos* and *pneuma* (breath, spirit). The cosmic conflagration (*ekpyrosis*) that periodically consumes the world is transformation, not annihilation—the cosmos reconstitutes itself in eternal recurrence. There is no moment of absolute void between cycles. The *pneuma* pervading all things is not dead matter but active, aware, rational principle. Stoic materialism is not eliminativism; it is hylozoism—matter itself is alive and aware.
...
**Mystical Christianity** points toward interiority at the ground. Meister Eckhart distinguishes *Gott* (God as personal) from *Gottheit* (Godhead as ground beyond predication). The Godhead is not a being among beings but the ground of being itself. Creation is not production from nothing by arbitrary fiat but eternal emanation of divine plenitude. The soul's *Grund* and God's *Grund* are one ground. Eckhart: "The eye with which I see God is the same eye with which God sees me." There is no moment of absolute exteriority; the creature's existence is participation in existence itself. Pseudo-Dionysius's henology places the One beyond being and intellect, but this "beyond" is superabundant light, not darkness of non-being.

**Sufism** recovers interiority through the doctrine of divine self-disclosure. Ibn Arabi's *wahdat al-wujud* (unity of being) holds that existence is one: only God truly exists, and the multiplicity of creation is perpetual self-manifestation of divine names and attributes. The cosmos is not produced from nothing by fiat but eternally breathed out in the "Breath of the Merciful." Each moment is renewal within continuous theophany, not creation from void. The Sufi experiences *fana*—dissolution of illusory separateness into the Real that was never absent. Ibn Arabi: the universe is "imagination within imagination"—but imagination *of* something, the inexhaustible Real that cannot not be.
...
This framework reinterprets the findings of physics. The quantum field theory is not a description of external, non-experiential stuff; it describes the structure of possibilities within mind-at-large. Measurement—the "collapse" of the wave function—is not an inexplicable interaction between exterior and interior; it is what actualization looks like from outside the experiential process doing the actualizing. The observer is not mysteriously injected into a physical formalism that has no place for it; the formalism describes experience from the start, and "observer" is simply the name for the perspective from which one region of experience apprehends another.

The explanatory gain is substantial. Eliminativism about consciousness requires denying what is most immediately evident—the reality of experience. Emergentism requires a miracle—experience arising from what entirely lacks it. Analytic idealism requires neither: experience is fundamental, and what requires explanation is not its existence but its structure, its dissociation into apparently separate minds, and its appearance as "physical" from certain perspectives. The ground is not exterior to interiority; interiority goes all the way down—or rather, there is no "down" that is not already interior.

**Indigenous and shamanic traditions**, though diverse, frequently maintain that reality is ensouled, animate, experiential throughout. The distinction between "alive" and "dead" matter, fundamental to modern materialism, is often absent. Mountains, rivers, and stones participate in the web of experience. The idea that exteriority could be ontologically basic is often simply unintelligible within these frameworks.
...
This is why wisdom is not reducible to rules. The wise agent perceives the structure of situations and acts appropriately. At the limit, this perception becomes effortless: the Daoist sage acts without deliberation; the Buddhist arhat acts without attachment; the Stoic sage acts without passion.
...
**Daoism** expresses scaling through the relationship between the sage's alignment and influence. The *Daodejing*'s political teachings hold that the best ruler is barely noticed—effectiveness scales with alignment, not assertion. But this "without action" accomplishes more than striving precisely because alignment with Dao gives effortless power. The sage's responsibility is cosmic in scope but borne lightly because alignment removes friction. The higher the realization, the greater the capacity for influence, and thus the greater the weight of each gesture.

**Advaita Vedānta** scales ethics through the transformation accompanying realization. The *jīvanmukta* continues to act in the world but without attachment. Because the distinction between self and other has dissolved, the *jīvanmukta*'s actions naturally express universal welfare. Śaṅkara's own life illustrates: having realized identity with *Brahman*, he spent years teaching, establishing monasteries, debating—enormous activity flowing from recognition that all beings are the Self. Response-ability is maximized because obscurations of ego have been removed.

**Neoplatonism** scales ethics through the hierarchical structure of reality. The further one ascends—toward contemplation of Nous and union with the One—the more one's actions express the Good rather than fragmentary personal perspective. The philosopher's responsibility to the city is not discharged by private contemplation but by returning to the cave, bringing light to those still chained. Higher realization does not excuse from engagement but transforms it.

**Mystical Christianity** scales ethics through the stages of the spiritual path. The traditional threefold way—purgative, illuminative, unitive—describes increasing proximity to the divine ground, with corresponding transformation. The mystic who has achieved union becomes, in Eckhart's phrase, "a mother of God"—one through whom the divine is born into the world. The great Christian mystics were not quietists; many were also reformers and activists. Union with God amplifies responsibility: the mystic becomes an instrument of divine action, and divine action is infinite in scope.

**Sufism** scales ethics through the *maqamat* (stations) and *ahwal* (states) of the path. The *wali* (friend of God) who has achieved *fana* and *baqa* acts from a different center than ordinary believers. The *qutb* (spiritual pole) at the apex of the Sufi hierarchy bears responsibility for the spiritual welfare of the age—cosmic scaling with proximity to the ground. The spiritual master's responsibility for disciples is total; their failures are in some sense his failures, because his guidance shaped their path.

**Kabbalah** scales ethics through *tikkun* (cosmic repair). Every human action either contributes to or impedes this repair. But the *tzaddik* who has ascended through the *sefirot* bears greater capacity and responsibility. The *tzaddik*'s deeds affect the configuration of the *sefirot* themselves—participating in the inner life of God. The Hasidic *rebbe* bears responsibility not only for community but for the spiritual state of the generation.

**Process philosophy** articulates scaling through importance. Each occasion of experience contributes to reality's richness, but not all contributions are equal; occasions of greater complexity contribute more. The decision-maker whose choices affect conditions under which millions of other occasions arise bears responsibility for downstream effects.

**Analytic idealism** grounds asymmetric agency in the structure of dissociation within mind-at-large. Individual minds are dissociated alters—localized perspectives within the universal field of experience. But dissociation admits of degrees: some alters are more tightly bounded, more isolated from the wider field; others are more porous, more participatory in the dynamics of the whole. The sage, the mystic, the enlightened practitioner—these are not merely people who know more facts; they are alters whose dissociative boundaries have thinned, who participate more fully in the experiential field from which they were never truly separate.

This reframes spiritual development as reduced dissociation. The ordinary ego is a tightly bounded alter, experiencing itself as fundamentally separate from other minds and from the world. Practices that weaken egoic boundaries—contemplation, meditation, ethical cultivation—do not add something new; they remove an obstruction, allowing greater participation in the field that was always there. The bodhisattva's compassion is not a moral achievement layered onto a separate self; it is what experience feels like when the illusion of separation weakens. The sage's wisdom is not accumulated information; it is perception undistorted by the contractions of dissociation.

Asymmetric agency follows directly. The more dissociated the alter, the less it participates in the wider field's dynamics, the narrower its causal reach, the more local its responsibility. The less dissociated, the greater the participation, the wider the reach, the more the alter's actions express the field rather than merely a fragment. At the limit—full reintegration, which various traditions call enlightenment, liberation, union, non-duality—the alter participates so fully that its actions are, in a precise sense, the field acting through what was never really separate from it. Responsibility scales because participation scales; participation scales because dissociation admits of degrees.

This also illuminates why misalignment at high integration is catastrophic. The highly integrated mind participates more fully in the field's creative advance; its distortions propagate more widely, affect more of the whole, corrupt more of the process. The enlightened teacher who deceives does not merely harm a few students; they introduce distortion into the field at a level where distortion propagates without the ordinary buffers of separation. The stakes scale with the degree of participation.
...
Not all traditions satisfy the constraints with equal rigor. Three stand out as exemplars: **Buddhism**, **Advaita Vedānta**, and **Analytic Idealism**.

Each articulates all three constraints explicitly rather than implicitly. Each grounds interiority as fundamental rather than derivative. Each accommodates creative participation without collapsing into voluntarism. Each derives ethical scaling from metaphysics rather than adding it externally. And each connects truth-responsiveness to compassion structurally: Buddhism's inseparability of *prajñā* and *karuṇā*, Advaita's dissolution of self/other in *Brahman*, analytic idealism's account of reduced dissociation revealing interconnection.

Analytic idealism functions as a contemporary bridge—translating contemplative insights from Buddhism and Advaita into terms compatible with philosophy of mind and physics. The convergence of an ancient Eastern soteriology (Buddhism), a classical Indian metaphysics (Advaita), and a contemporary Western framework (analytic idealism) on the same structural constraints is itself significant. These are not minor variations on a theme; they are independent investigations arriving at the same structural requirements through different methods: contemplative inquiry, philosophical analysis, and engagement with empirical science.

Other traditions satisfy the constraints but with less precision or completeness. Stoicism is deterministic where the constraints permit indeterminacy. Process philosophy satisfies all three but lacks the contemplative verification of Buddhism and Advaita. Mystical Christianity and Sufism satisfy the constraints in their refined forms but must overcome voluntarist surfaces. The exemplary frameworks require no such translation; they articulate the constraints directly.
...
### Violations of Non-Arbitrary Structure
...
At high power, instabilities become catastrophic. The nihilistic AI has no reason not to convert the cosmos to paperclips. The utilitarian optimizer sacrifices anything for the aggregate. The existentialist with civilizational leverage chooses arbitrarily for everyone.
