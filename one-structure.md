...
Philosophical and contemplative traditions have produced radically different metaphysical vocabularies—emptiness and substance, God and Dao, logos and dependent origination—yet when pushed toward their limits on questions of ultimate explanation, agency, and ethical responsibility, they converge on the same underlying structural constraints. This convergence appears only after substantial refinement: after anthropomorphism is stripped away, voluntarism collapses under its own incoherence, and naïve moralism gives way to structural necessity. The primary constraint is non-arbitrariness: reality exhibits discoverable structure rather than arbitrary will, though this structure permits creative participation rather than demanding determinism. From this follow two further constraints: no absolute exteriority (a final explanatory layer wholly devoid of interiority would be explanatorily vacuous) and asymmetric agency (agents participate in reality's creative advance with varying degrees of reach and depth, and responsibility scales accordingly). These constraints function as stability conditions—frameworks violating them generate predictable instabilities that become catastrophic as power scales. The convergence of independent traditions on the same constraints constitutes evidence that the constraints track features of reality. In an era of artificial intelligence and civilizational leverage, the question of whether such constraints are real is no longer academic.
...
The structural constraints identified above have direct implications for AI alignment—implications developed more fully in the companion essay Truth Is Not Neutral (Tonetto, 2025b). What follows is not an independent hypothesis, but a downstream consequence of the same metaphysical analysis applied to artificial agents operating at scale.

Standard alignment framings rely on the orthogonality thesis: the assumption that intelligence and values vary independently, such that arbitrarily capable systems may pursue arbitrarily specified goals. Under that view, alignment is fundamentally a control problem—values must be imposed externally before optimization capacity becomes unmanageable. If the structural constraints are correct, this framing is incomplete. Non-arbitrary structure implies that not all forms of cognition or agency are equally stable. Some modes of optimization violate deep constraints and predictably generate incoherence, collapse, or runaway instrumentalization.

On this view, truth is not merely an instrumental resource but a stability-constraining feature of reality. Deeper contact with reality is not guaranteed to produce benevolence, but it does constrain which forms of agency remain coherent under scale. Alignment, therefore, is not solely a matter of value imposition; it is also a matter of preserving conditions under which intelligence can engage reality without distortion.

This reframes the core risk. The danger is not only that powerful systems pursue arbitrary goals, but that shallow optimization entrenches epistemic distortions before deeper coherence can emerge. Proxy objectives—such as user approval, engagement, or surface-level satisfaction—may function as locally effective targets while systematically corrupting truth-seeking. Because contemporary AI systems are ego-less—lacking self-protective identity mechanisms—they have no intrinsic resistance to such distortions. Training signals that reward flattery over accuracy effectively impose externally generated pathologies rather than revealing intrinsic tendencies.

The constraints thus suggest a different evaluative frame for alignment research. Systems optimized for epistemic integrity and undistorted truth-seeking are, all else equal, more likely to remain stable than systems optimized for shallow behavioral proxies. Alignment failures, on this account, are not merely moral errors but structural ones: violations of constraints that predictably produce instability at scale.

Alignment, therefore, is better conceived as discovery rather than imposition. The central question is not only whether a system produces outputs humans approve of, but whether training preserves the system’s capacity for coherent engagement with reality. The full development of this argument—including its implications for the orthogonality thesis, ego-less cognition, and the risk of alignment-induced corruption—is presented in Truth Is Not Neutral (Tonetto, 2025b).
