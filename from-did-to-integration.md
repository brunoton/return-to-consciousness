...
This definition is deliberately neutral about underlying mechanisms. Whether dissociation involves neural isolation, attentional gating, narrative exclusion, or some combination, the functional result is the same: boundaries within experience that create the appearance of separate selves or separate domains of awareness.

Crucially, dissociation is not equivalent to pathology. Pathology arises when fragmentation is rigid, uncontrolled, or maladaptive. But dissociation as such—the capacity of consciousness to partition itself—is simply a feature of how minds work. Healthy functioning involves selective attention, role differentiation, and context-appropriate identity presentations, all of which involve dissociative mechanisms operating within normal parameters.
